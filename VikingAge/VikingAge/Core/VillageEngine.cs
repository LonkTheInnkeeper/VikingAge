...
using VikingAge.Objects.Buildings.Professional;

namespace VikingAge.Core
{
    internal class VillageEngine : GameManager
    {
        // Sort all buildings in lists by the building type
        ...
        // Display all buildings and their stats in sorted collums
        // Is there a way to simplify this? I don't like these repetitions
        ...
        // Get buildings from GameManager and sort them to lists
        // Is there a more efficient way?
        private void GetBuildings()
        {
            // Clear lists to be updated
            farms.Clear();
